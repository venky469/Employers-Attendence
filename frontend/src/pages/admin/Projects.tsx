...
// //     teamLead: Yup.string().required(t("project.teamLead") + " " + t("common.error")),
// //   })
...
// //       project.teamLead.name.toLowerCase().includes(searchTerm.toLowerCase()),
// //   )

// //   const displayProjects = filteredProjects.filter((project) => {
// //     if (tabValue === 0) return true // All
// //     if (tabValue === 1) return project.isActive // Active
// //     if (tabValue === 2) return !project.isActive // Inactive
// //     return true
// //   })
...
// //                     <Typography variant="body2">{project.teamLead.name}</Typography>
// //                   </Box>
...
// //               </Grid>
// //               <Grid item xs={12}>
// //                 <FormControl fullWidth error={formik.touched.teamLead && Boolean(formik.errors.teamLead)}>
// //                   <InputLabel id="teamLead-label">{t("project.teamLead")}</InputLabel>
// //                   <Select
// //                     labelId="teamLead-label"
// //                     id="teamLead"
// //                     name="teamLead"
// //                     value={formik.values.teamLead}
// //                     label={t("project.teamLead")}
// //                     onChange={formik.handleChange}
// //                     onBlur={formik.handleBlur}
// //                   >
...
// //                     <FormHelperText>{formik.errors.teamLead}</FormHelperText>
// //                   )}
// //                 </FormControl>
// //               </Grid>
// //               <Grid item xs={12}>
...
//         description: project.description || "",
//         startDate: new Date(project.startDate),
//         endDate: project.endDate ? new Date(project.endDate) : null as Date | null, // Explicitly cast to Date | null
//         dailyWageRate: project.dailyWageRate?.toString() || "",
//         farmer: project.farmer._id || "",
//         teamLead: project.teamLead._id || "",
//         isActive: project.isActive !== undefined ? project.isActive : true,
...
//                         fullWidth: true,
//                         error: formik.touched.startDate && Boolean(formik.errors.startDate),
//                         helperText: formik.touched.startDate && formik.errors.startDate ? String(formik.errors.startDate) : undefined, // Cast to string
//                       },
//                     }}
//                   />
//                 </LocalizationProvider>
...
//                         fullWidth: true,
//                         error: formik.touched.endDate && Boolean(formik.errors.endDate),
//                         helperText: formik.touched.endDate && formik.errors.endDate ? String(formik.errors.endDate) : undefined, // Cast to string
//                       },
//                     }}
//                   />
//                 </LocalizationProvider>
  ...
  const handleOpenDialog = (mode: "add" | "edit", project?: any) => {
    ...
    if (mode === "edit" && project) {
      ...
      formik.setValues({
        ...
        description: project.description || "",
        startDate: new Date(project.startDate),
        endDate: project.endDate ? new Date(project.endDate) : null, // No need for casting with explicit type
        dailyWageRate: project.dailyWageRate?.toString() || "",
        farmer: project.farmer._id || "",
        teamLead: project.teamLead._id || "",
        isActive: project.isActive !== undefined ? project.isActive : true,
